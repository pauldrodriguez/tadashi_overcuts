...
namespace Overcuts_Program
{
    class WholesalesOvercuts : Overcuts
    {
        ...
        private String buildQueryOrder(String productCode, String colorCode, String orderFrom = "", String orderTo = "")
        {
           ...
           "WHERE A.CSNO4E<>777 AND A.PRCD4E='" + productCode.ToUpper() + "' AND A.CRCD4E='" + colorCode.ToUpper() + "'";
            if (orderFrom != "")
            {
        ...
        public override void setTableLayoutSizes(TableLayoutPanel tableLayout)
        {
            ...
            {
                tableLayout.Controls.Add(new Label() { Text = product.Value, Dock = DockStyle.Fill, Anchor = AnchorStyles.None, TextAlign = ContentAlignment.MiddleCenter }, columnIndex++, row);
            }
        }
